...
BITCOIND=${BITCOIND:-$BINDIR/cpuchaind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/cpuchain.conf}
...
then
  ...
  echo -e "To safely generate a cpuchain.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example cpuchain.conf file in share/examples/'
