# Bootstrappable CPUchain Core Builds

This directory contains the files necessary to perform bootstrappable CPUchain
Core builds.
...
To build CPUchain Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      CPUchain Core version being built.
