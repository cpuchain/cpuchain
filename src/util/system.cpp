...
const char * const BITCOIN_CONF_FILENAME = "cpuchain.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CPUchain";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CPUchain";
#else
    // Unix-like
    return pathRet / ".cpuchain";
#endif
#endif
}
