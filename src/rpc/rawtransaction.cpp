    ...
    return
         {
             ...
             {RPCResult::Type::STR, "address", /*optional=*/true, "The CPUchain address (only if a well-defined address exists)"},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed CPUchain transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed CPUchain transactions into one transaction.\n"
