...
{
    switch (unit) {
    case Unit::BTC: return QString("CPU");
    case Unit::mBTC: return QString("mCPU");
    case Unit::uBTC: return QString::fromUtf8("µCPU (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("CPUchains");
    case Unit::mBTC: return QString("Milli-CPUchains (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-CPUchains (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
